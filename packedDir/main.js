...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Search\", function() { return Search; });\nconst searchTemplate = __webpack_require__(/*! ../../modules/API/search.pug */ \"./modules/API/search.pug\");\n\nclass Search {\n    constructor(data = {}, parent = document.body) {\n        this._data = data;\n        this._parent = parent;\n\n    }\n\n    get data() {\n        return this._data;\n    }\n\n    set data(dataToSet) {\n        this._data = {...dataToSet};\n    }\n\n    get parent() {\n        return this._parent;\n    }\n\n    set parent(parent) {\n        this._parent = parent;\n    }\n    renderSearch(search) {\n        this._data[\"search\"] = true;\n        this._parent.innerHTML = searchTemplate(this._data);\n    }\n}\n\n//# sourceURL=webpack:///./components/Search/Search.js?");
...
eval("var pug = __webpack_require__(/*! ../../../node_modules/pug-runtime/index.js */ \"../node_modules/pug-runtime/index.js\");\n\nfunction template(locals) {var pug_html = \"\", pug_mixins = {}, pug_interp;pug_html = pug_html + \"\\u003Cn\\u003E\\u003C\\u002Fn\\u003E\";;return pug_html;};\nmodule.exports = template;\n\n//# sourceURL=webpack:///./modules/API/search.pug?");
