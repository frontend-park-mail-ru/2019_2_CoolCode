...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ \"./modules/config.js\");\n\nclass FetchError extends Error {\n\tconstructor(response) {\n\t\tsuper();\n\t\tthis.name = 'FetchError';\n\t\tthis.message = _config__WEBPACK_IMPORTED_MODULE_0__[\"responseStatuses\"][response.status] +\n            \" error occured while fetching \" + response.url;\n\t\tthis.status = response.status;\n\t\tthis.url = response.url;\n\t}\n\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (FetchError);\n\n//# sourceURL=webpack:///./modules/API/fetchError.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../main */ \"./main.js\");\n\n\n\nasync function createMainPage () {\n\ttry {\n\t\tlet response = await _main__WEBPACK_IMPORTED_MODULE_0__[\"FetchModule\"]._doGet({path: '/users'});\n\t\t_main__WEBPACK_IMPORTED_MODULE_0__[\"bus\"].emit('userLoggedIn', response.status === 200);\n\t\t_main__WEBPACK_IMPORTED_MODULE_0__[\"router\"].go('/');\n\n\t} catch (error) {\n\t\tconsole.error(error);\n\t}\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (createMainPage);\n\n//# sourceURL=webpack:///./modules/API/mainpage.js?");
