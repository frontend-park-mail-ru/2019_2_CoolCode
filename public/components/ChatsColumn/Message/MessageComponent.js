...
class MessageComponent extends BaseComponent {
	...
	renderMessageFoundInChannel() {
		...
		message.className = 'message-channel-found chat-block chat-block_size chat-block_found';
	...
	renderMessageFoundInChat() {
		const message = document.createElement('div');
		message.className = 'message-chat-found chat-block chat-block_size chat-block_found-ch';
	...
	render() {
		const message = document.createElement('div');
		message.className = 'chat-block chat-block_size chat-block_style';
